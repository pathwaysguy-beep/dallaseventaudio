...
'Every booking is full service: we own the equipment, deliver it, set it up, run it for the event and take it away. Every wireless microphone runs our AI-powered De-Feedback system. Every quote is written for the room and returned within 24 hours. Phone and text: 817-210-7957. Quotes: ' + HOST + '/contact', '']
